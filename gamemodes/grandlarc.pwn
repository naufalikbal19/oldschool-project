...
//modular//
#include "MODULES\DATA\DEFINE.pwn"
#include "MODULES\DATA\MAPPING.pwn"
//----------------------------------------------------------
...
//simple login sistem by nopaaal19//
#define Register 0
#define Logged 1
//-----------------------------//
...
{
	print("\n---------------------------------------");
	print("Running Old School Project\n");
	print("---------------------------------------\n");
}
...
{
	GameTextForPlayer(playerid,"~w~Old School Project",3000,4);
  	SendClientMessage(playerid,COLOR_WHITE,"Welcome to {88AA88}Gld School Roleplay");
	//Simple login system by nopaaal19//
	Login[playerid] = 0;
...
public OnPlayerSpawn(playerid)
{
	...
	SetPlayerPos(playerid,513.95, -2497.85, 1.28);
